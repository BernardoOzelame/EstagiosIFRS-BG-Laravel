...
Route::prefix('supervisores')->middleware('auth')->group(function() {
    Route::get('/', [SupervisoresController::class, 'index'])->name('supervisores');
    Route::get('/cadastrar', [SupervisoresController::class, 'cadastrar'])->name('supervisores/cadastrar');
    Route::post('/cadastrar', [SupervisoresController::class, 'gravar'])->name('supervisores/gravar');
    Route::get('/editar/{supervisor}', [SupervisoresController::class, 'editar'])->name('supervisores/editar');
    Route::put('/editar/{supervisor}', [SupervisoresController::class, 'editarGravar']);
    Route::get('/apagar/{supervisor}', [SupervisoresController::class, 'apagar'])->name('supervisores/apagar'); 
    Route::delete('/apagar/{supervisor}', [SupervisoresController::class, 'deletar']);
});