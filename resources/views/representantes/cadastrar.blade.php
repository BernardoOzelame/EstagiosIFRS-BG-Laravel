...
@section('titulo', 'Cadastrar Representante')
...
@section('conteudo')
    ...
    <form action="{{ route('representantes/gravar') }}" method="POST" id="formulario">
        @csrf
        ...
        <input type="text" name="funcao" id="funcao" placeholder="Função" value="{{ old('funcao') }}">
