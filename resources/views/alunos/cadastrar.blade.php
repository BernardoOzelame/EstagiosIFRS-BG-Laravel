...
@section('conteudo')
    ...
    <form action="{{ route('alunos/gravar') }}" method="POST" id="formulario">
        @csrf
        ...
        <input type="text" name="matricula" id="matricula" placeholder="Matrícula" value="{{ old('matricula') }}">
